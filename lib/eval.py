...
def eval_ppl(args, model, tokenizer, dataset1, device=torch.device("cuda:0")):
    ...
    # print(dataset1) ptb
    # print(model.seqlen) 2048
    # print(tokenizer)  LlamaTokenizer(name_or_path='/home/fhl/.cache/huggingface/hub/models--decapoda-research--llama-7b-hf/snapshots/5f98eefcc80e437ef68d457ad7bf167c2c6a1348/', vocab_size=32000, model_max_length=1000000000000000019884624838656, is_fast=False, padding_side='right', truncation_side='right', special_tokens={}, clean_up_tokenization_spaces=False),  added_tokens_decoder={}
    # exit()
